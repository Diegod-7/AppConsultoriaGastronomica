...
// Configuración de áreas de evaluación con los checklists profesionales
const areas = {
    eficiencia: {
        nombre: 'Eficiencia Operacional Cocina',
        icon: 'fa-cogs',
        items: [
            '¿Existe layout optimizado en cocina (zonas definidas)?',
            '¿Se aplican fichas técnicas con gramajes y tiempos?',
            '¿El mise en place está estandarizado y operativo?',
            '¿Se controlan tiempos de preparación y despacho?',
            '¿Se cumple con limpieza y orden según checklist diario?',
            '¿Hay control de proveedores y recepción de insumos eficaz?'
        ]
    },
    costos: {
        nombre: 'Gestión de Costos y Rentabilidad',
        icon: 'fa-calculator',
        items: [
            '¿Se conocen los costos exactos por plato?',
            '¿Se ha calculado el punto de equilibrio?',
            '¿Los precios están alineados a costos y mercado?',
            '¿Se realiza control de mermas semanal?',
            '¿Existe control de gastos operativos y costos ocultos?',
            '¿Se revisa rentabilidad mensual por producto o línea?'
        ]
    },
    inventarios: {
        ...
        icon: 'fa-boxes',
        items: [
            '¿Existe un inventario maestro con stock mínimo/máximo?',
            '¿Se realiza inventario semanal completo?',
            '¿La bodega está ordenada según PEPS (FIFO)?',
            '¿Se registran entradas y salidas de stock correctamente?',
            '¿Se compara consumo real vs. ventas (control cruzado)?',
            '¿Hay control de productos perecibles y caducidad?'
        ]
    },
    servicio: {
        nombre: 'Experiencia del Cliente y Servicio',
        icon: 'fa-smile',
        items: [
            '¿Existe protocolo de atención, bienvenida y despedida?',
            '¿El personal está capacitado en hospitalidad y venta?',
            '¿Se miden tiempos de atención y entrega?',
            '¿Hay gestión de reclamos y protocolos para resolverlos?',
            '¿Se realizan encuestas de satisfacción o feedback?',
            '¿Se ofrece venta sugestiva de productos o promociones?'
        ]
    },
    marketing: {
        nombre: 'Marketing Digital y Fidelización',
        icon: 'fa-bullhorn',
        items: [
            '¿El perfil de Google My Business está optimizado?',
            '¿Las redes sociales están activas y bien gestionadas?',
            '¿Existe calendario de contenidos para redes?',
            '¿Se realizan campañas pagadas (Meta/Google Ads)?',
            '¿Se tiene base de datos de clientes (email, WhatsApp)?',
            '¿Existen programas de fidelización o recompensas?'
        ]
    },
    talento: {
        nombre: 'Gestión de Talento y Liderazgo',
        icon: 'fa-users',
        items: [
            '¿Hay organigrama definido y actualizado?',
            '¿Existen manuales de funciones para cada rol?',
            '¿Se aplican procesos de reclutamiento formal?',
            '¿Existe un plan de inducción y capacitación inicial?',
            '¿Se hacen evaluaciones de desempeño periódicas?',
            '¿Hay sistema de incentivos o reconocimientos?'
        ]
    },
    finanzas: {
        ...
        icon: 'fa-chart-pie',
        items: [
            '¿Se lleva control del flujo de caja semanal/mensual?',
            '¿Se cruzan ventas (POS) con efectivo y tarjetas?',
            '¿Hay registro digital de ingresos y egresos?',
            '¿Se controla la rentabilidad por canal (local, delivery)?',
            '¿Las cuentas por pagar y cobrar están al día?',
            '¿Se realizan proyecciones financieras trimestrales?'
        ]
    },
    innovacion: {
        nombre: 'Innovación de Carta y Producto',
        icon: 'fa-lightbulb',
        items: [
            '¿Se analiza la venta de cada plato o producto?',
            '¿Los productos de baja rotación se eliminan o modifican?',
            '¿Se desarrollan nuevos productos periódicamente?',
            '¿Los nuevos platos responden a tendencias (veggie, sin gluten, etc.)?',
            '¿Cada nuevo producto tiene costeo y precio bien definido?',
            '¿Se capacita al equipo sobre los nuevos lanzamientos?'
        ]
    },
    sostenibilidad: {
        ...
        icon: 'fa-leaf',
        items: [
            '¿Se han medido los consumos de energía, gas y agua?',
            '¿Se usan insumos biodegradables o compostables?',
            '¿Existe separación y gestión de residuos?',
            '¿Hay campañas internas de concientización ambiental?',
            '¿Se comunican acciones sostenibles al cliente?',
            '¿Se han reducido los residuos o el consumo energético?'
        ]
    },
    escalabilidad: {
        nombre: 'Escalabilidad y Nuevos Canales',
        icon: 'fa-expand-arrows-alt',
        items: [
            '¿Se ha evaluado el modelo de expansión (sucursal, dark kitchen, franquicia)?',
            '¿Se conoce la rentabilidad real por cada canal?',
            '¿Existen manuales operativos listos para replicar el modelo?',
            '¿Se cuenta con propuesta financiera para inversionistas?',
            '¿Hay plan de marketing y apertura para nuevas unidades?',
            '¿Se han probado canales complementarios (delivery, catering, eventos)?'
        ]
    }
};
